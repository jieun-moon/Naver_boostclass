# -*- coding: utf-8 -*-
"""3. 2레이어 인공신경망 심화_제출용.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ByOb68Db6UgNZuJB-d04d6jwWHsYGNmu
...
def optimize(X, Y, _params, learning_rate=0.1, iteration=1000):
    params = [param.copy() for param in _params] # 파라미터 복사
    loss_trace = [] # 손실 값 저장

    for epoch in range(iteration): # 학습 반복
        dparams, loss = get_gradients(X, Y, params) # 그라디언트 추출
        for i in range(len(params)):
            params[i] -= learning_rate * dparams[i] # 경사하강법 구현
